#line 1 "/home/terry/Projects/motor_control_firmware/MotorController.hpp"
...
private:
  ...
  const int motorPulseTotals[2] = {8080, 8080};
...
public:
  ...
  void initialize()
  {
    ...
    motors[0] =
        Motor("Leader", MotorPin::MOTOR1_RPWM_PIN, MotorPin::MOTOR1_LPWM_PIN,
              ...
              ControlPin::LEFT_CURRENT_SENSE_PIN,
    ...
    motors[1] =
        Motor("Follower", MotorPin::MOTOR2_RPWM_PIN, MotorPin::MOTOR2_LPWM_PIN,
              ...
              ControlPin::RIGHT_CURRENT_SENSE_PIN,
  ...
  */
  ...
  void setPos(const int newPos) { motors[LEADER].setPos(newPos); }
  ...
  void update(const float deltaT = 0.0f)
  {
    ...
    if (!pid_on)
    {
      motors[leadingIndex].speed = 255;
      motors[laggingIndex].speed = 255;
