...
constexpr int MIN_MOTOR_TRAVEL_SPEED = 100;
...
constexpr int SOFT_MOVEMENT_TIME_MS = 3399;
 ...
 * current alarm. */
constexpr int CURRENT_ALARM_DELAY = 2000000;
...
constexpr int CURRENT_INCREASE_TOLERANCE_PERCENTAGE = 7;
